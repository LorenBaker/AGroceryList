...
public class ListsTable {
	...
	public static final String LIST_VIEW_FIRST_VISIBLE_POSITION = "listViewFirstVisiblePosition";
	public static final String LIST_VIEW_TOP = "listViewTop";

	public static final String MASTER_LIST_VIEW_FIRST_VISIBLE_POSITION = "masterListViewFirstVisiblePosition";
	public static final String MASTER_LIST_VIEW_TOP = "masterListViewTop";
	...
	public static final String[] PROJECTION_ALL = { COL_LIST_ID, COL_LIST_TITLE, COL_ACTIVE_STORE_ID,
			...
			LIST_VIEW_FIRST_VISIBLE_POSITION, LIST_VIEW_TOP,
			MASTER_LIST_VIEW_FIRST_VISIBLE_POSITION, MASTER_LIST_VIEW_TOP
	};
	...
	private static final String CREATE_TABLE = "create table "
			...
			+ LIST_VIEW_FIRST_VISIBLE_POSITION + " integer default 0, "
			+ LIST_VIEW_TOP + " integer default 0,"

			+ MASTER_LIST_VIEW_FIRST_VISIBLE_POSITION + " integer default 0, "
			+ MASTER_LIST_VIEW_TOP + " integer default 0"
			+ ");";
